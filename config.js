...
module.exports = {
    ...
    // Owner Settings
    OWNER_NUMBER: process.env.OWNER_NUMBER || '923124001592', // ᴀᴅᴅ ʏᴏᴜʀ ᴏᴡɴᴇʀ ɴᴜᴍʙᴇʀ
    OWNER_NAME: process.env.OWNER_NAME || '𝐅𝐌 𝐀𝐁𝐃𝐔𝐋𝐋𝐀𝐇', // ᴀᴅᴅ ʏᴏᴜʀ ᴏᴡɴᴇʀ ɴame
    
    // Channel Links
    CHANNEL_LINK: process.env.CHANNEL_LINK || 'https://whatsapp.com/channel/0029VbBwUOZ6BIEaxmYl3m1Z',
